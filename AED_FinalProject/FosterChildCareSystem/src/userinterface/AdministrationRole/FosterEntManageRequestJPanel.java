...
public class FosterEntManageRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Manage Foster Center Work Requests");
        add(lblTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, -1, -1));
        ...
        add(scrollpaneTable, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 850, 100));

        btnAccept.setFont(new java.awt.Font("Segoe Print", 0, 11)); // NOI18N
        btnAccept.setText("Accept");
        add(btnAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 330, -1, -1));

        btnReject.setFont(new java.awt.Font("Segoe Print", 0, 11)); // NOI18N
        btnReject.setText("Reject");
        add(btnReject, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 330, -1, -1));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 260, 740, 270));
