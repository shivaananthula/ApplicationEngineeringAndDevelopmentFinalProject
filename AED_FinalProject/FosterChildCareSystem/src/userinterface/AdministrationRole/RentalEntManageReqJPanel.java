...
public class RentalEntManageReqJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(scrollpaneTable, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 850, 100));

        btnAccept.setFont(new java.awt.Font("Segoe Print", 0, 11)); // NOI18N
        btnAccept.setText("Accept");
        add(btnAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 310, -1, -1));

        btnReject.setFont(new java.awt.Font("Segoe Print", 0, 11)); // NOI18N
        btnReject.setText("Reject");
        add(btnReject, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 310, -1, -1));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 740, 270));
